    ...
    <SafeAreaView className="flex-1 bg-background-0">
      ...
      <Box className="justify-center flex-1">
        <Box className="flex-col items-center justify-start px-4 pt-4 bg-raisin border-b border-typography-100">
          ...
          <Box className="w-full rounded-2xl bg-background-100 p-2 pb-2 mt-5">
            <Box className="flex-row items-center justify-between gap-2">
              <Pressable
                className={`flex-1 mx-1 flex-row items-center justify-center p-2 rounded-xl ${
              ...
              >
                ...
                >
                  Creatre a parking space
                </Text>
              </Pressable>
            </Box>
          </Box>
          <Heading className="text-typography-50 text-lg font-semibold mt-4">
            QuickPark
          </Heading>
                ...
                >
                  <HStack space="sm">
                    ...
                    <Pressable
                      ...
                      onPress={() => setVehicle({ ...vehicle, type: "bike" })}
                    >
                      <Image
                    ...
                    <Pressable
                      ...
                      onPress={() => setVehicle({ ...vehicle, type: "truck" })}
                    >
                      <Image
                    ...
                    <Pressable
                      ...
                      onPress={() => setVehicle({ ...vehicle, type: "van" })}
                    >
                      <Image
                    ...
                    <Pressable
                      ...
                      onPress={() => setVehicle({ ...vehicle, type: "auto" })}
                    >
                      <Image
